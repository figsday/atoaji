...
「後味」とは飲食のあとで口内に残った味のことを言いますが、転じて物事が済んだあとに残る感じや気分のことも言います。<br>
このアプリケーションでは映画を見た後の気分を「後味」と呼び、自分のなりたい気分を想像しながら映画を選んで欲しいという思いが込められています。
...
# 目指した課題解決
映画を見るときに、何を見るか悩み、やっと鑑賞し始めても内容が想像と違ければ見るのをやめてしまうことがあります。これでは一つの映画を見るために無駄な時間を費やしてしまいます。<br>
そこで、映画鑑賞後の具体的な気分を「後味」として提示することで、「映画選択に余計な時間がかかってしまう」、「鑑賞したい映画が見つからない」という課題を解決しようとしました。<br>
また、ユーザーが映画の投稿をすることで、その映画を見たい人の参考になるとともに、内容の感想を共有できます。
